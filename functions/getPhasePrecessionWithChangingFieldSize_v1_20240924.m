function [data, settings] = getPhasePrecessionWithChangingFieldSize_v1_20240924(data, settings, processedDataPath)
                ...
                for iCluster = 1:n;
                    ...
                    if isempty(FRdata{iAnimal}(iCluster).metaData) == 1; 
                        ...
                        for iDir = 1%:length(directions);
                            ...
                            spikeTimes = outputData.spikesByDirection; barcode = outputData.barcode;
