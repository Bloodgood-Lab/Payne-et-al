function filePaths = splitWTandKO_v1_20240722(mainDataStructure, settings, processedDataPath) 
    ...
    saveFile_v1_20240718(processedDataPath, filePaths, settings, 'filePathsByGenotype') 
