            ...
            if isempty(genotypeData{iAnimal}) == 1; 
                ...
                for iCluster = 1:n;
                    ...
                    for iDir = 1:2; 
                        ...
                        outputData.(genotypes{iGenotype}).(fr){iAnimal}(iCluster).binnedSpikesByTrial.highVelocityData.unbinnedSpkPos.(dir) = genotypeData{iAnimal}(iCluster).highVelocityData.unbinnedSpkPos.(dir);
                        ...
                        outputData.(genotypes{iGenotype}).(fr){iAnimal}(iCluster).binnedSpikesByTrial.allVelocities.unbinnedSpkPos.(dir) = genotypeData{iAnimal}(iCluster).allVelocities.unbinnedSpkPos.(dir);
